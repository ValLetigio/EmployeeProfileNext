    ...
    >
        ...
        >  
            <div className='w-full h-full overflow-auto'>
                ...
                {/* for print to pdf */} 
                <div 
                    className='h-max w-full py-8 px-4 md:px-8 pb-20 '
                    ref={memoRef}
                > 
                    ...
                    <div className="my-8 border-l pl-4 grid grid-cols-1 lg:grid-cols-5 items-center lg:gap-4">
                        ...
                        <div className={headerTextStyle}>{memoForPrintModal?.Employee?.name}</div>
                        ...
                        <div className={headerTextStyle}>{memoForPrintModal?.date?.substring(0,16)}</div> 

                        <div className="col-span-1 font-semibold">Subject:</div>
                        <div className={headerTextStyle}>{memoForPrintModal?.subject}</div>

                        <div className="col-span-1 font-semibold">Code:</div>
                        <div className={headerTextStyle}>{memoForPrintModal?.MemoCode?.description}</div>
                    </div>
                    ...
                    {/* memo message */}
                    <div className='px-2 '>
                        <h3>Dear Mr./Ms. <strong>{memoForPrintModal?.Employee?.name}</strong> ,</h3>
                        <br/> 
                        <p className='indent-4 whitespace-pre-line'>{memoForPrintModal?.description}</p>
                        <br/>  
                        <br/>  
                        <div className='float-end w-[75%] md:w-[50%] xl:w-[35%] border-b text-center pb-2 border-black'>  THE MANAGEMENT  </div>
                        <br />
                        <br />
                    </div>  
                    ...
                    <div className=' w-full '>
                        ...
                        <div className='float-end w-[75%] md:w-[50%] xl:w-[35%] '>
                            ...
                            <div className=' text-center text-xs'>(Name, Signature, Date)</div>
                        </div>
                        <br />
                        <br />
                    </div> 
                    ...
                    <div className=' text-center w-full mt-2'> For management use only </div>
