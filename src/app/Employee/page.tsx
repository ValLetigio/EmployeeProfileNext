...
const page = () => {
  ...
  return (
    <div className='relative h-screen w-screen flex items-center justify-center overflow-clip'>
        <h1 className='blur-[3px] absolute text-3xl md:text-6xl lg:text-8xl font-semibold mb-6 tracking-[15px] md:tracking-[35px] lg:tracking-[55px] opacity-80'>Employee</h1>
