...
const Page = async () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-start">
      ...
      <div className=" md:h-[90vh] overflow-auto w-[99vw] lg:w-[97vw] justify-between flex flex-wrap ">
        ...
        <div className=" h-12 w-[45%] lg:w-[10%] flex items-center justify-end mr-2 ">
          <Link
            className="h-12 w-12 text-xl border tooltip tooltip-left
            bg-gray-100 hover:border-gray-700  hover:text-black
            shadow-sm shadow-gray-600 p-0 rounded-full flex items-center justify-center "
            data-tip={"Create/Update/Delete an Employee"}
            href={"/Employee"}
          >
            <svg
        ...
        <div className="w-full lg:w-[65%] h-max lg:h-[92%] flex flex-wrap items-center justify-between p-4 gap-4 lg:gap-0 ">
          ...
          <div className="w-[100%] max-h-[95vh] lg:h-[75%] p-4 shadow-md shadow-gray-500 rounded-xl flex flex-col items-start justify-between border ">
            <div className=" w-full overflow-auto h-full">
              <div className="text-xl font-semibold tracking-tighter sticky left-0 top-1 mb-2 w-full flex items-center justify-between px-3">
                Employees
