...
const Page = async () => {
  ...
  return (
    <div className=" flex flex-col items-center justify-center h-max md:h-[100vh] ">
      <BackButton />
      <div className="scale-0 h-[10vh] md:h-[5vh] w-full" />
      <NotAuthorized employeeResponse={employeeResponse}/>
      ...
      <div className=" md:h-[90vh] overflow-auto w-[99vw] lg:w-[97vw] justify-between flex flex-wrap ">
        ...
        <div className=" h-12 w-[45%] lg:w-[10%] flex items-center justify-end mr-2 ">
          <Link
            ...
            shadow-sm shadow-gray-600 p-0 rounded-box flex items-center justify-center "
